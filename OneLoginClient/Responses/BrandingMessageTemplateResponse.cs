...
{
    public class BrandingMessageTemplateResponse
    {
        /// <summary>
    ...
    /// <summary>
    /// Represents the actual content of an email template, including both HTML and plain text versions.
    /// </summary>
    public class Template
    {
        ...
        /// <summary>
        /// Gets or sets the HTML version of the email template.
        /// </summary>
        [JsonPropertyName("html")]
        public string Html { get; set; }

        /// <summary>
        /// Gets or sets the plain text version of the email template.
        /// </summary>
