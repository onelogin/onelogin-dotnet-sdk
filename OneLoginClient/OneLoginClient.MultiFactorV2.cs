...
namespace OneLogin
{
    public partial class OneLoginClient
    {
        ...
        /// <param name="registrationid">Set to the uuid of the registration. This was included in the response as part of the initial request in Enroll Factor.</param>
        /// <returns>Returns the serialized <see cref="VerifyFactorMFAResponse"/> as an asynchronous operation.</returns>
        public async Task<ApiResponse<VerifyFactorMFAResponse>> VerifyEnrollmentSMSEMailProtectAuthenticator(int userId, int registrationid, VerifyEnrollmentRequest request)
        {
        ...
        public async Task<ApiResponse<BaseStatusResponse>> VerifySMSEmailAuthenticatorFactorPost(int userId, VerifySMSEmailAuthenticatorFactorRequest request)
        {
        ...
        /// <returns>Returns the serialized <see cref="BaseStatusResponse"/> as an asynchronous operation.</returns>
        public async Task<ApiResponse<BaseStatusResponse>> VerifySMSEmailAuthenticatorFactor(int userId, int verificationId, VerifySMSEmailAuthenticatorFactorRequest request)
        {
        ...
        /// <param name="request"></param>
        /// <returns>Returns the serialized <see cref="GetEnrolledAuthenticationFactorResponse"/> as an asynchronous operation.</returns>
        public async Task<ApiResponse<GenerateMFATokenResponse>> GenerateMFAToken(int userId, GenerateMFATokenRequest request)
        {
