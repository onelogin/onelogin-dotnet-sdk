...
namespace OneLogin
{
    public partial class OneLoginClient
    {
        ...
        {
            return await GetResourceV1<GetEventTypesResponse>($"{Endpoints.ONELOGIN_EVENTS}/types", Endpoints.BaseApiVersion1);
        }
            ...
            DateTime? since = null, DateTime? until = null, int? userId = null)
        {
            ...
            return await GetResourceV1<GetEventsResponse>(url, Endpoints.BaseApiVersion1);
        }
        ...
        {
            return await GetResourceV1<GetEventsResponse>($"{Endpoints.ONELOGIN_EVENTS}/{id}", Endpoints.BaseApiVersion1);
        }
        ...
        {
            return await PostResourceV1<EmptyResponse>($"{Endpoints.ONELOGIN_EVENTS}", message, Endpoints.BaseApiVersion1);
        }
