...
namespace OneLogin
{
    ...
    public partial class OneLoginClient
    {
        ...
        /// <param name="appId">The id of the application that where the rules apply.</param>
        /// <returns></returns>
        public async Task<ApiResponse<List<AppRulesConditionsActionsResponse>>> ListConditions(long appId)
        {
            try
            {
                return await GetResource<List<AppRulesConditionsActionsResponse>>($"{Endpoints.ONELOGIN_APPS}/{appId}/rules/conditions", Endpoints.BaseApiVersion2);
            }
            catch (Exception ex)
            {
                return new ApiResponse<List<AppRulesConditionsActionsResponse>>(status: new BaseErrorResponse { Message = ex.Message, StatusCode = 500 });
            }
        }
        ...
        /// <returns></returns>
        public async Task<ApiResponse<List<AppRulesConditionsActionsResponse>>> ListConditionOperators(long appId, string? conditionValue)
        {
            try
            {
                return await GetResource<List<AppRulesConditionsActionsResponse>>($"{Endpoints.ONELOGIN_APPS}/{appId}/rules/conditions/{conditionValue}/operators", Endpoints.BaseApiVersion2);
            }
            catch (Exception ex)
            {
                return new ApiResponse<List<AppRulesConditionsActionsResponse>>(status: new BaseErrorResponse { Message = ex.Message, StatusCode = 500 });
        ...
        /// <param name="conditionValue">The value for the selected condition</param>
        /// <returns></returns>
        public async Task<ApiResponse<List<AppRulesConditionsActionsResponse>>> ListConditionValues(long appId, string? conditionValue)
        {
            try
            {
                return await GetResource<List<AppRulesConditionsActionsResponse>>($"{Endpoints.ONELOGIN_APPS}/{appId}/rules/conditions/{conditionValue}/values", Endpoints.BaseApiVersion2);
            }
            catch (Exception ex)
            {
                return new ApiResponse<List<AppRulesConditionsActionsResponse>>(status: new BaseErrorResponse { Message = ex.Message, StatusCode = 500 });
        ...
        /// <param name="appId">The id of the application that where the rules apply.</param>
        /// <returns></returns>
        public async Task<ApiResponse<List<AppRulesConditionsActionsResponse>>> ListActions(long appId)
        {
            try
            {
                return await GetResource<List<AppRulesConditionsActionsResponse>>($"{Endpoints.ONELOGIN_APPS}/{appId}/rules/actions", Endpoints.BaseApiVersion2);
            }
            catch (Exception ex)
            {
                return new ApiResponse<List<AppRulesConditionsActionsResponse>>(status: new BaseErrorResponse { Message = ex.Message, StatusCode = 500 });
        ...
        /// <returns></returns>
        public async Task<ApiResponse<List<AppRulesConditionsActionsResponse>>> ListActionValues(long appId, string actionValue)
        {
            try
            {
                return await GetResource<List<AppRulesConditionsActionsResponse>>($"{Endpoints.ONELOGIN_APPS}/{appId}/rules/actions/{actionValue}/values", Endpoints.BaseApiVersion2);
            }
            catch (Exception ex)
            {
                return new ApiResponse<List<AppRulesConditionsActionsResponse>>(status: new BaseErrorResponse { Message = ex.Message, StatusCode = 500 });
