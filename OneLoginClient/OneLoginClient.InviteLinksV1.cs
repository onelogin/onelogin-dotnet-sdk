namespace OneLogin
{
    public partial class OneLoginClient
    {
        ...
        {
            return await PostResourceV1<GenerateInviteLinkResponse>($"{Endpoints.ONELOGIN_INVITES}/get_invite_link", new GenerateInviteLinkRequest { Email = email }, Endpoints.BaseApiVersion1);
        }
        ...
        public async Task<BaseStatusResponse> SendInviteLink(string email, string personalEmail = null)
        {
            return await PostResourceV1<BaseStatusResponse>($"{Endpoints.ONELOGIN_INVITES}/send_invite_link", new SendInviteLinkRequest { Email = email, PersonalEmail = personalEmail }, Endpoints.BaseApiVersion1);
        }
    }
}
